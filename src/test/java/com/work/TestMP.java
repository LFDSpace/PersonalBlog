...
public class TestMP {
    private static String author ="lf";//作者名称s
    private static String outputDir ="D:\\";//生成的位置D:\StudyDatabase\workFile\blog
    ...
    private static String parentPackage = "com.work.blog";//顶级包结构
